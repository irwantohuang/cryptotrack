...
const NewsPage = () => {
    const { newsCorsData, loading, error } = useSelector((state: RootState) => state.news)
        ...
        <div className='w-full overflow-x-hidden py-4 lg:pb-20 lg:pt-[120px] '>
            <div className="container p-4 mx-auto">
                ...
                <div className="flex items-center justify-center mt-12 w-full mx-auto">
                    {(newsCorsData.data.length + 1) <= newsCorsData.totalHits && !loading && !error && <Button className="px-8" onClick={loadMore}>
                        Load more...
                    </Button>}
