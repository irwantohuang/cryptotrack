...
const CoinCard = ({ coin, index }: CoinCardProps) => {
    ...
    return (
        <Link to={`/cryptocurrencies/${coin.uuid}`} data-aos="fade-up" data-aos-delay={index * 100}>
        ...
        '>
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col items-start gap-1">
                        ...
                        <div>
                            <p className="inline-block text-primary-white-200">${formatNumber(Number(price), 4, 1)}</p>
