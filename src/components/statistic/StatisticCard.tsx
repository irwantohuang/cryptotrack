...
const StatisticCard = ({ title, subtitle, Icon, aos, delay }: StatisticCardProps) => {
    return (
        <div data-aos={aos} data-aos-delay={delay} className="w-[350px] rounded-md shadow-md lg:py-4 py-2 px-4 bg-primary-black hover:scale-105 transition-all duration-300 group">
