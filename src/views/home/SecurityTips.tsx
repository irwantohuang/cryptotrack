            ...
            <div className="w-full h-full py-20">
                <div className="container mx-auto p-4">
                    <div className="text-center max-w-screen-md mx-auto">
                        <p data-aos="zoom-out" className="text-xl font-semibold text-primary-300">Stay Safe in the Crypto World</p>
                        <p data-aos="zoom-in" className="text-2xl lg:text-4xl text-primary-white mt-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-screen-xl mx-auto mt-8 gap-y-8 gap-x-4 justify-items-center">
                        {securityData.map((security) => (
                            <div key={security.id} 
                                data-aos="zoom-in"
                                data-aos-delay={security.id * 100}
